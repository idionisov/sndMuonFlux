...
if __name__ == "__main__":
    ...
    parser.add_argument('-mct', '--MC-Truth', action='store_true', help="(Simulations) Wether to use the Monte Carlo Truth method or not. Defaults to Tagging track method.")
